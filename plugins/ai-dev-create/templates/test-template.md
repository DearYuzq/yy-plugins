...
| ID | 描述 | 输入 | 期望输出 | 约束 IDs | 状态 |
|----|------|------|----------|----------|------|
| UT-001 | {描述} | {输入} | {输出} | C-001, C-003 | ⬜ |
| UT-002 | {描述} | {输入} | {输出} | {约束 IDs} | ⬜ |
...
| ID | 描述 | API | 请求 | 响应 | 约束 IDs | 状态 |
|----|------|-----|------|------|----------|------|
| IT-001 | {描述} | POST /api/xxx | {请求} | {响应} | C-002 | ⬜ |
...
| ID | 场景 | 步骤 | 断言 | 约束 IDs | 状态 |
|----|------|------|------|----------|------|
| E2E-001 | {场景} | {步骤数} | {断言数} | C-001, C-004 | ⬜ |
